...
export type LatestTwabForCollectionBeforeTimeQueryVariables = Exact<{
  collection?: InputMaybe<Scalars['bpchar']>;
  earlierThan?: InputMaybe<Scalars['timestamptz']>;
}>;


export type LatestTwabForCollectionBeforeTimeQuery = { __typename?: 'query_root', twabs: Array<{ __typename?: 'twabs', price: any, token_address: any, created_at: any }> };
